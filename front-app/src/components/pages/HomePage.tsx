...
import { fetcher, type Game } from "@/lib/api";
          ...
          <div className="container relative mx-auto flex h-full flex-col justify-end p-8 pb-16">
            <div className="max-w-2xl space-y-4">
              <div className="flex items-center gap-2 text-sm font-medium text-primary">
                ...
                <span className="text-muted-foreground">Just Updated</span>
              </div>
              <h1 className="text-5xl font-extrabold tracking-tight lg:text-7xl">
                {featuredGame.title}
              </h1>
              <p className="text-lg text-muted-foreground">
                Experience the next generation of minimalist gaming. immerse yourself in a world of pure imagination.
              </p>
